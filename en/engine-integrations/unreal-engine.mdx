...
<Info>
  You can find the download link through our Discord server. Open the **Download plugin** section and select the channel for **Unreal Engine**.
</Info>

<CardGroup cols={2}>
  <Card title="Unreal Engine 5.5" icon="download">
    <Badge color="green">Available on Discord</Badge>

    Download the package from the Unreal Engine channel inside **Download plugin**.
  </Card>
