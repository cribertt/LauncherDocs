...
<Card
  title="Descargar Launcher Forge Auth para Unreal Engine"
  icon="download"
  href="https://discord.com/invite/2DwJtD9E3T"
>
  <img
    src="/images/screenshots/engine-integrations/shared/discord-download-plugin.png"
    alt="Categoría DOWNLOAD PLUGIN de Discord con el canal de Unreal Engine"
  />
  ...
  Para Unreal Engine, abre el canal:
...
<CardGroup cols={2}>
  <Card title="Unreal Engine 5.5" icon="cube">
    <Badge color="green">Disponible en Discord</Badge>
  </Card>

  <Card title="Unreal Engine 5.6" icon="cube">
    <Badge color="green">Disponible en Discord</Badge>
  </Card>

  <Card title="Unreal Engine 5.7" icon="cube">
    <Badge color="green">Disponible en Discord</Badge>
  </Card>

  <Card title="Unreal Engine 5.8" icon="cube">
    <Badge color="green">Disponible en Discord</Badge>
  </Card>
</CardGroup>

<Note>
  Utiliza siempre el paquete correspondiente a la versión exacta de Unreal Engine de tu proyecto.
</Note>
...
El proyecto gratuito `GameLauncherClient` está preparado para **Unreal Engine 5.5** e incluye:
...
<Card
  title="Descargar GameLauncherClient para UE 5.5"
  icon="folder-open"
  href="https://discord.com/invite/2DwJtD9E3T"
>
  <img
    src="/images/screenshots/engine-integrations/shared/discord-download-templates.png"
    alt="Categoría DOWNLOAD TEMPLATES de Discord con el canal del proyecto GameLauncherClient"
  />
  ...
  Para el proyecto de ejemplo de Unreal Engine, abre el canal:
...
<Note>
  El proyecto está preparado para Unreal Engine 5.5. Para versiones posteriores puede requerir recompilación.

  El plugin es gratuito y no debe comercializarse ni revenderse por separado.
</Note>
